  ...
  <div class="container">
    ...
    <div class="principle">
      ...
      <div class="principle-line2">
        用圣心培育每一个孩子，让他们成为具有创造性，充满爱心和热情的学习者。
      </div>
    </div>
    <div class="video">
      ...
      <div class="introduction-main">
        <div class="introduction-main-left">
          ...
          <div class="introduction-main-left__name">
            ...
            <br />
            <span class="introduction-main-left__name--text2"
              >Director of Education</span
            >
          </div>
        </div>
        <div class="introduction-main-right">
          <div class="introduction-main-right__text">
            作为圣心教育集团的教育总监，Alison Cook
            女士是资深幼儿教育专家，英国国际学校理事会(COBIS）同行认证人，IEYC(Fieldwork)
            官方培训师。在过去25
            年，她曾在英国、土耳其、阿塞拜疆和马来西亚，担任过各种教育职务，包括校长、教育顾问和教师培训师。
          </div>
    ...
    <div class="footer">
      <div class="footer-item1">
        ...
        <div class="footer-item1__text">
          地址：广州市越秀区烟雨路28号南侧一楼及二楼
        </div>
      </div>
      <div class="footer-item1">
        <div>广州圣心国际幼儿园 珠江校区</div>
        <div class="footer-item1__text">
          地址：广州市天河区珠江新城花城大道663号
        </div>
      </div>
      <div class="footer-item1">
        <div>广州圣心国际幼儿园 花都校区</div>
        <div class="footer-item1__text">
          地址：广州市花都区花城街凤凰北路34号之68号
        </div>
      </div>
        ...
        if (data.children[0].children.length === 0) {
          ...
          this.$router.push({
            ...
            query: {
              ...
              title: data.children[0].children[0].name,
            },
          });
        }
      }
