<template>
  <div class="container">
    ...
    <div class="principle">
      ...
      <div class="principle-line2">
        To nurture the sacred heart in every child to become a creative, caring
    ...
    <div class="video">
      <div class="video-item" v-for="(item, index) in videoList" :key="index">
        ...
        <div class="video-item--title">
          <span class="video-item--title__text">{{
            item.video_english_title
          }}</span>
        </div>
      ...
      <div class="introduction2-main">
        <div class="introduction2-main-left">
          ...
          <div class="introduction2-main-left__name">
            <span class="introduction2-main-left__name--text1"
              >Alison Cook</span
            >
            <br />
            <span class="introduction2-main-left__name--text2"
              >Director of Education</span
            >
          </div>
        </div>
        <div class="introduction2-main-right">
          <div class="introduction2-main-right__text">
            The Director of Education for the Trinity Group, Alison Cook is an
            early years and primary expert, as well as a Council of British
            International Schools (COBIS) Accreditor and IEYC (Fieldwork)
            Curriculum Trainer. Over her twenty-five years of experience in
            education she has worked in the UK, Turkey, Azerbaijan and Malaysia
            in a variety of educational roles including Principal, Educational
            Consultant, Inspector and Teacher Trainer.
          </div>
